...
const PrivacyPolicy = () => {
  return (
    <div className={styles.PrivacyPolicy}>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to slaysheet.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to slaysheet, accessible from{" "}
            <a
              href="https://www.slaysheet.com"
      ...
      <ul>
        <li>By email: arkalal.chakravarty@gmail.com</li>
      </ul>
    </div>
  );
};
